...
case '2':
  ...
  case 'q':
   ...
   // let k = color(0);
    djdrawBlackline2(color(0), mouseX, mouseY, pmouseX, pmouseY);
    break;


  case 'w':
    console.log("w");  //thick white line
    djdrawWhiteline2(color(255), mouseX, mouseY, pmouseX, pmouseY);
    break;
...
case '4':
  console.log("4");  // big layered colorful ellipses
    rectMode(CENTER);
    translate(-50,-50);
  djlayeredRand1(color(180, 100, 100), mouseX, mouseY, pmouseX, pmouseY);
  break;

  case '5':
    console.log("5");  // small layered neutral ellipses
    djlayeredRand2(color(180, 100, 100), mouseX, mouseY, pmouseX, pmouseY);
    break;
...
function djdrawBlackline2( k,  lx, ly,  px, py) {
 // strokeWeight(1);
  stroke(k);
  strokeWeight(10);
  line(lx, ly, px, py);
...
function djdrawWhiteline2( k,  lx, ly,  px, py) {
 // strokeWeight(1);
  stroke(k);
  strokeWeight(10);
  line(lx, ly, px, py);
...
function djlayeredRand1( k,  lx, ly,  px, py) {
  // strokeWeight(10);
...
function djlayeredRand2( k,  lx, ly,  px, py) {
  // strokeWeight(10);
